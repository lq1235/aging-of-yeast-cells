...
yyaxis left
h1=plot(a(1:4:end,1),a(1:4:end,2),'ro-', 'LineWidth', 1, 'MarkerFaceColor', 'red', 'MarkerSize', 6.2);
hold on
xlim([-0.3   5]);
ylim([  20   120]);
...
yyaxis right
h2=plot(b(1:4:end,1),b(1:4:end,2),'bo-', 'LineWidth', 1, 'MarkerFaceColor', 'blue', 'MarkerSize', 6.2);
xlim([-0.3   5]);
ylim([ 15    110]);
leg = legend([h1, h2], 'Mode 1', 'Mode 2', 'fontsize', 10);
set(leg, 'Position', [0.4, 0.81, 0.2, 0.1]);
